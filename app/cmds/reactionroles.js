...
module.exports.run = async(client,message,args)=> {
  ...
  let reactions = await msg.awaitReactions(filter, {//cydia//cydia//cydia//cydia//cydia//cydia
    max: 1,//cydia
    time: 60000,//cydia//cydia
    errors: ["time"]//cydia//cydia//cydia
  });
  let choice = reactions.get("✅") || reactions.get("❌");//cydia//cydia
  if (choice.emoji.name === "✅") {
    let emb = new Discord.MessageEmbed()//cydia
      .setColor("#FF5349")
      .setDescription(roles.text || `Bu rolü almak için emojiye bas :  <@&${roles.role}> -cydia`);
  ...
  let string = random(24);
    ...
    message.channel.send("Komutu iptal ettiniz - Cydia");
  }
